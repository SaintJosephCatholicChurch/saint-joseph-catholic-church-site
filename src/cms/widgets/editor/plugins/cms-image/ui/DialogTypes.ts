...
export type ListValue = Ui.Dialog.ListBoxSingleItemSpec;
export type ListGroup = Ui.Dialog.ListBoxNestedItemSpec;
export type ListItem = Ui.Dialog.ListBoxItemSpec;
...
export type API = Ui.Dialog.DialogInstanceApi<ImageDialogData>;
