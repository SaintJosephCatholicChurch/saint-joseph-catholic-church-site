...
const baseBibleAbbreviationRegexString = `${bibleBooksAbbreviationRegexString}[  \\t]*([0-9]+)[  \\t]*[:]{0,1}[  \\t]*([0-9]+)?(?:[  \\t]*[-]{1}[  \\t]*[0-9]+)?`;
const bibleAbbreviationRegexString = `(?:^|[  \\t]{1})(${baseBibleAbbreviationRegexString})`;
