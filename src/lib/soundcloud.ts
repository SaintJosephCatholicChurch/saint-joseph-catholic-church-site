...
export async function getDailyReadingIFrameUrl(): Promise<string | null> {
  try {
    ...
    return `https://w.soundcloud.com/player?url=${contents.url}&auto_play=false&hide_related=true&show_comments=false&show_user=false&show_reposts=false&show_teaser=true&visual=true`;
  } catch (e) {
