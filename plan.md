...
11. `[ ]` Phase 11: TypeScript and developer utility modernization
    ...
    Notes: Keep TypeScript on a conservative supported path for Next 16 and the current typed-lint stack; do not jump to a new major without confirming support first.
