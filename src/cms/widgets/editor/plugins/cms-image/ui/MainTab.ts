...
const makeItems = (info: ImageDialogInfo): Ui.Dialog.BodyComponentSpec[] => {
  const imageUrl = {
    name: 'src',
    type: 'urlinput',
    filetype: 'image',
  ...
  const getDialogContainerType = (useColumns: boolean) =>
...
const makeTab = (info: ImageDialogInfo): Ui.Dialog.TabSpec => ({
  title: 'General',
  name: 'general',
