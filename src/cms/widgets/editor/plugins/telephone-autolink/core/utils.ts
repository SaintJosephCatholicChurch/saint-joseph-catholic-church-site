...
const isNonPhoneNumberCharacter = (char: string): boolean => /^[^\(\)\-0-9 ]$/.test(char);
...
export { freefallRtl, findChar, isElement, isTextNode, isPunctuation, isNonPhoneNumberCharacter, isSpace };
