...
const ParishRegistrationForm = () => {
  ...
  const errors = useMemo(() => validateParishRegistration(formData), [formData]);
    ...
    <StyledFormWrapper>
      ...
      <StyledParishRegistrationForm onSubmit={onSubmit} $submitted={submitted}>
        ...
        <StyledSection>
          ...
          <StyledHelperText>
            Add each dependent child from the paper form. Remove any blank child entries before submitting.
          </StyledHelperText>
